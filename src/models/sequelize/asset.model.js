...
UserModel.hasMany(AssetModel, {foreignKey: "responsible_id", as: "responsible", onDelete: "CASCADE"})
AssetModel.belongsTo (UserModel, {foreignKey: "responsible_id", as: "responsible"})